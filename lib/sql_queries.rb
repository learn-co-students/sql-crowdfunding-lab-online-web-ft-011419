...
"SELECT projects.title, (SUM(pledges.amount - projects.funding_goal)) AS x FROM projects JOIN pledges ON projects.id = pledges.project_id GROUP BY projects.title HAVING x >= 0;"
end# this is wrong#
